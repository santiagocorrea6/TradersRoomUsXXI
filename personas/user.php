<?php session_start();
  ...
  $sql = "SELECT * FROM personas WHERE user = '$user'";
  ...
  $img = $result["img"];
  $msg = $result["msg"];
  $inst = $result["instagram"];
  $face = $result["facebook"];
  $wpp = $result["wpp"];
?>
        ...
        <div class="col-lg-4 col-md-7 col-sm-12">
          <div class="card profile-card-3">
            ...
            <div class="profile-thumb-block">
              ...
              <?php echo '<img src="../img/personas/'.$img.'" alt="profile-image" class="profile">'; ?>
            </div>

            <div class="card-content">
              <h2><br><?php echo "$name"; ?><small style="text-align: justify;"><?php echo "$msg";?></small></h2>
    
              <div class="icon-block">
                <?php echo '<a href="'.$inst.'">'?><i class="fa fa-instagram"></i></a>
                <?php echo '<a href="'.$face.'">'?><i class="fa fa-facebook"></i></a>
                <?php echo '<a href="'.$wpp.'">'?><i class="fa fa-whatsapp"></i></a></div>
                <!--a href="https://www.instagram.com/yamidpro/"-->
            </div>
          </div>
        </div>
      </div>
